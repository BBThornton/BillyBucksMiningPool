                            ...
                            switch (jsonData.method) {
                                ...
                                case 'sendTransaction':
                                    if (replyJson.error != null) {
                                        ...
                                        tempReply.result.fee = replyJson.transactionHash;
                                        replyJson = tempReply;
                                    }
                                    break;
                                case 'submitblock':
                            ...
                            switch (jsonData.method) {
                                ...
                                case 'getBalance':
                                    if (replyJson.error != null) {
                                        ...
                                        tempReply.result.availableBalance = replyJson.unlocked / 100;
                                        tempReply.result.lockedAmount = replyJson.locked / 100;
                                        replyJson = tempReply;
                                    }
                                    break;
                                case 'getblockheaderbyheight':
